...
newList = []
for index in range(len(list_of_claim_nums_1)):
    newList.append(list_of_claim_nums_1[index])
    newList.append(list_of_claim_nums_2[index])
# print(newList)

newString = ""
for eachElement in newList:
    newString += str(eachElement) + "  "
print("The newly created list contains:     " + newString)
# ```
# Example Output:
# ```
